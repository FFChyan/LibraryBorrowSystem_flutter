...
//          )
    ...
    if (widget.titleTag != null && !DartHelper.isNullOrEmpty(widget.title)) {
      title = HeroText(
        ...
        style: theme.textTheme.display2.copyWith(letterSpacing: 5),
...
class FlutterLogin extends StatefulWidget {
  FlutterLogin({
    ...
    this.title = 'LOGIN',
    this.logo, // just logo path
    this.messages,
    this.theme,
    this.emailValidator,
    this.passwordValidator,
    this.onSubmitAnimationCompleted,
    this.touristModeAccess,
    this.logoTag,
    this.titleTag,
  ...
  final Function touristModeAccess;
...
//  底下 debug 一排
  ...
  ThemeData _mergeTheme({ThemeData theme, LoginTheme loginTheme}) {
    ...
    final pageColorLight = loginTheme.pageColorLight ?? theme.primaryColorLight;
    ...
    return theme.copyWith(
      primaryColorLight: pageColorLight,
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint("2) build _FlutterLoginState");
                    ...
                    Positioned(
                      child: AuthCard(
                        ...
                        onSubmitCompleted: (value) =>
                            widget.onSubmitAnimationCompleted(value),
                        touristMode: widget.touristModeAccess,
                      ),
                    ),
                    Positioned( // logo
